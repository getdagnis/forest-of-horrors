...
When in forest-of-horrors directory or other roblox related directory you are running with roblox-ai-os-creator-skills (RCS), a coordination layer for Codex CLI.
...
- Prefer evidence over assumption; verify before claiming completion. Ask user when in doubt.
...
| `planner` | `gpt-5.6-terra` | medium | Task sequencing, execution plans, risk flags (frontier-orchestrator, frontier) |
| `architect` | `gpt-5.6-terra` | high | System design, boundaries, interfaces, long-horizon tradeoffs (frontier-orchestrator, frontier) |
...
| `security-reviewer` | `gpt-5.6-terra` | medium | Vulnerabilities, trust boundaries, authn/authz (frontier-orchestrator, frontier) |
...
| `build-fixer` | `gpt-5.6-terra` | high | Build/toolchain/type failures resolution (deep-worker, standard) |
